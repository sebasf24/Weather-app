   ...
   const handleSearch =async (e)=>{
    ...
    return(
        <div className={style.navBar}>
            ...
            <svg  xmlns="http://www.w3.org/2000/svg" height="2.5em" width="2.5em"
viewBox="0 0 48 48"
